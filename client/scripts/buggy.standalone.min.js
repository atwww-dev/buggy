/**
 * Buggy - Bug Reporting Tool v1.0.0 (Standalone)
 * https://github.com/yourusername/buggy
 * Licensed under MIT
 */
var BuggyExports=(()=>{var v=Object.defineProperty;var E=Object.getOwnPropertyDescriptor;var S=Object.getOwnPropertyNames;var T=Object.prototype.hasOwnProperty;var M=(a,t)=>{for(var e in t)v(a,e,{get:t[e],enumerable:!0})},L=(a,t,e,o)=>{if(t&&typeof t=="object"||typeof t=="function")for(let r of S(t))!T.call(a,r)&&r!==e&&v(a,r,{get:()=>t[r],enumerable:!(o=E(t,r))||o.enumerable});return a};var B=a=>L(v({},"__esModule",{value:!0}),a);var z={};M(z,{Buggy:()=>x,default:()=>R});var f=class{constructor(){this.currentTool="pen",this.currentColor="#000000",this.isDrawing=!1,this.lastX=0,this.lastY=0,this.scale=1,this.offsetX=0,this.offsetY=0,this.isDragging=!1,this.dragStart={x:0,y:0}}async show(t){return new Promise((e,o)=>{this.showAnnotationTool(t,e,o)})}showAnnotationTool(t,e,o){let r=document.createElement("div");r.className="buggy-annotation-container",r.innerHTML=`
    ...
    `,document.body.appendChild(r);let i=r.querySelector("#buggy-canvas"),g=i.getContext("2d"),d=r.querySelector(".buggy-text-modal"),b=r.querySelector("#buggy-text-input"),s=new Image;s.onload=()=>{let c=Math.min(window.innerWidth*.85,s.width),h=Math.min(window.innerHeight*.75,s.height),m=s.width/s.height,y,n;s.width>c?(y=c,n=c/m):s.height>h?(n=h,y=h*m):(y=s.width,n=s.height),i.width=Math.round(y),i.height=Math.round(n),this.render(g,s),this.initializeDrawing(i,r,s,e)},s.onerror=()=>o(new Error("Failed to load screenshot")),s.src=t}render(t,e){let o=t.canvas;t.clearRect(0,0,o.width,o.height),t.drawImage(e,0,0,o.width,o.height)}initializeDrawing(t,e,o,r){let i=t.getContext("2d"),g=e.querySelector(".buggy-text-modal"),d=e.querySelector("#buggy-text-input"),b=e.querySelector(".buggy-text-add"),s=e.querySelector(".buggy-text-cancel"),c=0,h=0;e.querySelectorAll(".buggy-tool").forEach(n=>{n.addEventListener("click",l=>{e.querySelectorAll(".buggy-tool").forEach(u=>u.classList.remove("active")),l.target.closest(".buggy-tool").classList.add("active"),this.currentTool=l.target.closest(".buggy-tool").dataset.tool})}),e.querySelectorAll(".buggy-color").forEach(n=>{n.addEventListener("click",l=>{e.querySelectorAll(".buggy-color").forEach(u=>u.classList.remove("active")),l.target.classList.add("active"),this.currentColor=l.target.dataset.color})}),b.addEventListener("click",()=>{let n=d.value.trim();n&&(i.fillStyle=this.currentColor,i.font="16px Arial",i.fillText(n,c,h)),g.style.display="none",d.value=""}),s.addEventListener("click",()=>{g.style.display="none",d.value=""});let m=n=>{let l=t.getBoundingClientRect();return{x:n.clientX-l.left,y:n.clientY-l.top}},y=n=>{if(!this.isDrawing)return;let{x:l,y:u}=m(n);switch(i.strokeStyle=this.currentColor,i.fillStyle=this.currentColor,i.lineWidth=2,i.lineCap="round",this.currentTool){case"pen":i.beginPath(),i.moveTo(this.lastX,this.lastY),i.lineTo(l,u),i.stroke();break;case"arrow":this.render(i,o),this.drawArrow(i,this.lastX,this.lastY,l,u);break;case"rectangle":this.render(i,o),this.drawRectangle(i,this.lastX,this.lastY,l,u);break}[this.lastX,this.lastY]=[l,u]};t.addEventListener("mousedown",n=>{if(n.button!==0)return;this.isDrawing=!0;let{x:l,y:u}=m(n);[this.lastX,this.lastY]=[l,u],this.currentTool==="text"&&(this.isDrawing=!1,c=l,h=u,g.style.display="flex",d.focus())}),t.addEventListener("mousemove",y),t.addEventListener("mouseup",()=>{if(this.isDrawing){this.isDrawing=!1;let n=document.createElement("canvas");n.width=t.width,n.height=t.height,n.getContext("2d").drawImage(t,0,0),o.src=n.toDataURL()}}),t.addEventListener("mouseout",()=>{this.isDrawing=!1}),e.querySelector(".buggy-clear").addEventListener("click",()=>{this.render(i,o)}),e.querySelector(".buggy-done").addEventListener("click",()=>{let n=t.toDataURL("image/png");document.body.removeChild(e),r(n)})}drawArrow(t,e,o,r,i){let d=Math.atan2(i-o,r-e);t.beginPath(),t.moveTo(e,o),t.lineTo(r,i),t.stroke(),t.beginPath(),t.moveTo(r,i),t.lineTo(r-10*Math.cos(d-Math.PI/6),i-10*Math.sin(d-Math.PI/6)),t.lineTo(r-10*Math.cos(d+Math.PI/6),i-10*Math.sin(d+Math.PI/6)),t.closePath(),t.fill()}drawRectangle(t,e,o,r,i){t.strokeRect(Math.min(e,r),Math.min(o,i),Math.abs(r-e),Math.abs(i-o))}};var w=class{constructor(t){this.apiUrl=t}show(t){return new Promise((e,o)=>{let r=document.createElement("div");r.className="buggy-form-container",r.innerHTML=`
      ...
      `,document.body.appendChild(r);let i=r.querySelector(".buggy-form"),g=r.querySelector(".buggy-cancel");i.addEventListener("submit",async d=>{d.preventDefault();let b=new FormData(i),s={title:b.get("title"),description:b.get("description"),category:b.get("category"),priority:b.get("priority"),steps:b.get("steps"),screenshot:t,url:window.location.href,browser:this.getBrowserInfo()};try{let c=await fetch(this.apiUrl,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(s)});if(!c.ok)throw new Error("Failed to submit bug report");let h=await c.json();document.body.removeChild(r),e(h)}catch(c){console.error("Error submitting bug report:",c),o(c)}}),g.addEventListener("click",()=>{document.body.removeChild(r),o(new Error("Bug report cancelled"))})})}getBrowserInfo(){let t=navigator.userAgent,e="Unknown",o="";return t.includes("Firefox/")?(e="Firefox",o=t.split("Firefox/")[1]):t.includes("Chrome/")?(e="Chrome",o=t.split("Chrome/")[1].split(" ")[0]):t.includes("Safari/")&&!t.includes("Chrome")?(e="Safari",o=t.split("Version/")[1].split(" ")[0]):t.includes("Edge/")&&(e="Edge",o=t.split("Edge/")[1]),`${e} ${o}`}};async function k(){try{try{let a=await navigator.mediaDevices.getDisplayMedia({preferCurrentTab:!0,video:{width:window.innerWidth,height:window.innerHeight}});if(!a||a.getVideoTracks().length===0)throw new Error("Screen capture cancelled or no video tracks available");let t=a.getVideoTracks()[0];p("Captured current view. Processing...","info"),await new Promise(g=>setTimeout(g,500));let o=await new ImageCapture(t).grabFrame(),r=document.createElement("canvas");return r.width=o.width,r.height=o.height,r.getContext("2d").drawImage(o,0,0),t.stop(),a.getTracks().forEach(g=>g.stop()),r.toDataURL("image/png")}catch(a){if(console.error("Error with getDisplayMedia:",a),a.name==="NotAllowedError"||a.name==="AbortError"||a.message.includes("cancel")||a.message.includes("denied"))throw p("Screenshot cancelled. Bug report aborted.","info"),new Error("SCREENSHOT_CANCELLED");p("Unable to capture screenshot. Please describe the issue instead.","error");let t=document.createElement("canvas");t.width=window.innerWidth,t.height=window.innerHeight;let e=t.getContext("2d");return e.fillStyle="#f5f5f5",e.fillRect(0,0,t.width,t.height),e.fillStyle="#333",e.font="16px Arial",e.textAlign="center",e.fillText("Screenshot capture unavailable",t.width/2,t.height/2),t.toDataURL("image/png")}}catch(a){throw console.error("Error capturing screenshot:",a),a}}function C(){let a="buggy-styles";if(document.getElementById(a))return;let t=document.createElement("style");t.id=a,t.textContent=`
    .buggy-button {
      position: fixed;
      z-index: 10000;
      bottom: 30px;
  ...
  `,document.head.appendChild(t)}function p(a,t="info"){document.querySelectorAll(".buggy-message").forEach(r=>{document.body.removeChild(r)});let o=document.createElement("div");o.className="buggy-message",o.textContent=a,document.body.appendChild(o),setTimeout(()=>{o.style.animation="buggy-slide-out 0.3s ease forwards",setTimeout(()=>{document.body.contains(o)&&document.body.removeChild(o)},300)},3e3)}var x=class{constructor(t={}){this.apiUrl=t.apiUrl||"/api/feedback",this.buttonText=t.buttonText||"Report Bug",this.buttonPosition=t.buttonPosition||{bottom:"20px",right:"20px"},this.annotationTool=new f,this.bugReportForm=new w(this.apiUrl)}initialize(){C(),this.createButton()}createButton(){let t=document.createElement("button");t.className="buggy-button",t.textContent=this.buttonText,Object.assign(t.style,this.buttonPosition),t.addEventListener("click",()=>this.startBugReport()),document.body.appendChild(t)}async startBugReport(){try{let t;try{t=await k(),p("Screenshot captured successfully")}catch(r){if(r.message==="SCREENSHOT_CANCELLED")return null;throw r}let e=await this.annotationTool.show(t);p("Annotations saved");let o=await this.bugReportForm.show(e);return p("Bug report submitted successfully"),o}catch(t){throw t.message==="Bug report cancelled"?p("Bug report cancelled","info"):t.message==="SCREENSHOT_CANCELLED"||(console.error("Error in bug reporting flow:",t),p("Failed to complete bug report","error")),t}}};var R=x;typeof window<"u"&&(window.Buggy=x);return B(z);})();
